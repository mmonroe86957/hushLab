...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CustomerInvoicer',
            fields=[
                ('invoicenumber', models.AutoField(db_column='invoiceNumber', primary_key=True, serialize=False)),
                ('date', models.DateField(blank=True, null=True)),
                ('booknumber', models.CharField(blank=True, db_column='bookNumber', max_length=255, null=True)),
